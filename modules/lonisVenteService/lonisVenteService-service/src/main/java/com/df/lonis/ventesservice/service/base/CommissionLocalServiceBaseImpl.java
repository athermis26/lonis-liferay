...
/**
 * Provides the base implementation for the commission local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.df.lonis.ventesservice.service.impl.CommissionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.df.lonis.ventesservice.service.impl.CommissionLocalServiceImpl
 * @generated
 */
public abstract class CommissionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CommissionLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommissionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.df.lonis.ventesservice.service.CommissionLocalServiceUtil</code>.
	 */
	...
	public Commission addCommission(Commission commission) {
		...
		return commissionPersistence.update(commission);
	}
	...
	public Commission createCommission(long id) {
		return commissionPersistence.create(id);
	}
	...
	public Commission deleteCommission(long id) throws PortalException {
		return commissionPersistence.remove(id);
	}
	...
	public Commission deleteCommission(Commission commission) {
		return commissionPersistence.remove(commission);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return commissionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Commission.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return commissionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return commissionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return commissionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return commissionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Commission fetchCommission(long id) {
		return commissionPersistence.fetchByPrimaryKey(id);
	}
	...
	public Commission getCommission(long id) throws PortalException {
		return commissionPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(commissionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Commission.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			commissionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Commission.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return commissionPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommissionLocalServiceImpl#deleteCommission(Commission) to avoid orphaned data");
		}

		return commissionLocalService.deleteCommission(
			(Commission)persistedModel);
	}

	@Override
	public BasePersistence<Commission> getBasePersistence() {
		return commissionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return commissionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Commission> getCommissions(int start, int end) {
		return commissionPersistence.findAll(start, end);
	}
	...
	public int getCommissionsCount() {
		return commissionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CommissionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		commissionLocalService = (CommissionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CommissionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = commissionPersistence.getDataSource();
	...
	protected CommissionLocalService commissionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommissionLocalServiceBaseImpl.class);
