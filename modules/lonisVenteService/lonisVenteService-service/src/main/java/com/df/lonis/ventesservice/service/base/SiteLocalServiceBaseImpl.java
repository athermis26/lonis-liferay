 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.df.lonis.ventesservice.service.impl.SiteLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.df.lonis.ventesservice.service.impl.SiteLocalServiceImpl
 * @generated
 */
public abstract class SiteLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SiteLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.df.lonis.ventesservice.service.SiteLocalServiceUtil</code>.
	 */
	...
	public Site deleteSite(long id) throws PortalException {
		return sitePersistence.remove(id);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sitePersistence.dslQuery(dslQuery);
	}
	...
	public Site fetchSite(long id) {
		return sitePersistence.fetchByPrimaryKey(id);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SiteLocalServiceImpl#deleteSite(Site) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SiteLocalServiceBaseImpl.class);
