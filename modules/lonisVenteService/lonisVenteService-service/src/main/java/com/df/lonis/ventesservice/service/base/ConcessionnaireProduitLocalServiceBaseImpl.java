...
/**
 * Provides the base implementation for the concessionnaire produit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.df.lonis.ventesservice.service.impl.ConcessionnaireProduitLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.df.lonis.ventesservice.service.impl.ConcessionnaireProduitLocalServiceImpl
 * @generated
 */
public abstract class ConcessionnaireProduitLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ConcessionnaireProduitLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ConcessionnaireProduitLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.df.lonis.ventesservice.service.ConcessionnaireProduitLocalServiceUtil</code>.
	 */
	...
	public ConcessionnaireProduit addConcessionnaireProduit(
		...
		return concessionnaireProduitPersistence.update(concessionnaireProduit);
	}
	...
	public ConcessionnaireProduit createConcessionnaireProduit(long id) {
		return concessionnaireProduitPersistence.create(id);
	}
	...
	public ConcessionnaireProduit deleteConcessionnaireProduit(long id)
		...
		return concessionnaireProduitPersistence.remove(id);
	}
	...
	public ConcessionnaireProduit deleteConcessionnaireProduit(
		...
		return concessionnaireProduitPersistence.remove(concessionnaireProduit);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return concessionnaireProduitPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ConcessionnaireProduit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return concessionnaireProduitPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return concessionnaireProduitPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ConcessionnaireProduit fetchConcessionnaireProduit(long id) {
		return concessionnaireProduitPersistence.fetchByPrimaryKey(id);
	}
	...
	public ConcessionnaireProduit getConcessionnaireProduit(long id)
		...
		return concessionnaireProduitPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ConcessionnaireProduit.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return concessionnaireProduitPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ConcessionnaireProduitLocalServiceImpl#deleteConcessionnaireProduit(ConcessionnaireProduit) to avoid orphaned data");
		}

		return concessionnaireProduitLocalService.deleteConcessionnaireProduit(
			(ConcessionnaireProduit)persistedModel);
	}

	@Override
	public BasePersistence<ConcessionnaireProduit> getBasePersistence() {
		return concessionnaireProduitPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return concessionnaireProduitPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	...
	public List<ConcessionnaireProduit> getConcessionnaireProduits(
		...
		return concessionnaireProduitPersistence.findAll(start, end);
	}
	...
	public int getConcessionnaireProduitsCount() {
		return concessionnaireProduitPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		concessionnaireProduitLocalService =
			(ConcessionnaireProduitLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ConcessionnaireProduitLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource =
			concessionnaireProduitPersistence.getDataSource();
	...
	protected ConcessionnaireProduitLocalService
		concessionnaireProduitLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ConcessionnaireProduitLocalServiceBaseImpl.class);
