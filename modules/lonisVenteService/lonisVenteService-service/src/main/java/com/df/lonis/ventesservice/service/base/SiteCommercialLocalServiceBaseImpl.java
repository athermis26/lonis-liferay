...
/**
 * Provides the base implementation for the site commercial local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.df.lonis.ventesservice.service.impl.SiteCommercialLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.df.lonis.ventesservice.service.impl.SiteCommercialLocalServiceImpl
 * @generated
 */
public abstract class SiteCommercialLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SiteCommercialLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SiteCommercialLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.df.lonis.ventesservice.service.SiteCommercialLocalServiceUtil</code>.
	 */
	...
	public SiteCommercial addSiteCommercial(SiteCommercial siteCommercial) {
		...
		return siteCommercialPersistence.update(siteCommercial);
	}
	...
	public SiteCommercial createSiteCommercial(long id) {
		return siteCommercialPersistence.create(id);
	}
	...
	public SiteCommercial deleteSiteCommercial(long id) throws PortalException {
		return siteCommercialPersistence.remove(id);
	}
	...
	public SiteCommercial deleteSiteCommercial(SiteCommercial siteCommercial) {
		return siteCommercialPersistence.remove(siteCommercial);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return siteCommercialPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SiteCommercial.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return siteCommercialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return siteCommercialPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return siteCommercialPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return siteCommercialPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SiteCommercial fetchSiteCommercial(long id) {
		return siteCommercialPersistence.fetchByPrimaryKey(id);
	}
	...
	public SiteCommercial getSiteCommercial(long id) throws PortalException {
		return siteCommercialPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(siteCommercialLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SiteCommercial.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SiteCommercial.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return siteCommercialPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SiteCommercialLocalServiceImpl#deleteSiteCommercial(SiteCommercial) to avoid orphaned data");
		}

		return siteCommercialLocalService.deleteSiteCommercial(
			(SiteCommercial)persistedModel);
	}

	@Override
	public BasePersistence<SiteCommercial> getBasePersistence() {
		return siteCommercialPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return siteCommercialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SiteCommercial> getSiteCommercials(int start, int end) {
		return siteCommercialPersistence.findAll(start, end);
	}
	...
	public int getSiteCommercialsCount() {
		return siteCommercialPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SiteCommercialLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		siteCommercialLocalService = (SiteCommercialLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SiteCommercialLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = siteCommercialPersistence.getDataSource();
	...
	protected SiteCommercialLocalService siteCommercialLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SiteCommercialLocalServiceBaseImpl.class);
