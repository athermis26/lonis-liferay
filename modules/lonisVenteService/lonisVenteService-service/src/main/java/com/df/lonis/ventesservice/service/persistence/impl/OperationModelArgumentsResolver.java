...
/**
 * The arguments resolver class for retrieving value from Operation.
 *
...
@Component(
	property = {
		"class.name=com.df.lonis.ventesservice.model.impl.OperationImpl",
		"table.name=operations"
	},
	service = ArgumentsResolver.class
)
public class OperationModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		OperationModelImpl operationModelImpl = (OperationModelImpl)baseModel;
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= operationModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return OperationImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return OperationTable.INSTANCE.getTableName();
	}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = operationModelImpl.getColumnValue(columnName);
			}
		}
