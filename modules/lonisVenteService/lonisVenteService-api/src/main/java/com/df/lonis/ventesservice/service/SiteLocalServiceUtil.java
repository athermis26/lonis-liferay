 ...
 * <code>com.df.lonis.ventesservice.service.impl.SiteLocalServiceImpl</code> and
...
public class SiteLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.SiteLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new site
	 */
	public static Site createSite(long id) {
		return getService().createSite(id);
	}
	 ...
	 */
	public static Site deleteSite(long id) throws PortalException {
		return getService().deleteSite(id);
	}
	 ...
	 * @return the site that was removed
	 */
	public static Site deleteSite(Site site) {
	...
	public static Site fetchSite(long id) {
		return getService().fetchSite(id);
	}
	 ...
	 * @throws PortalException if a site with the primary key could not be found
	 */
	public static Site getSite(long id) throws PortalException {
		return getService().getSite(id);
	}
	 ...
	 */
	public static List<Site> getSites(int start, int end) {
	 ...
	 */
	public static Site updateSite(Site site) {
	...
	private static final Snapshot<SiteLocalService> _serviceSnapshot =
		new Snapshot<>(SiteLocalServiceUtil.class, SiteLocalService.class);
