...
public class SiteUtil {
	 ...
	 * @return the new site
	 */
	public static Site create(long id) {
	 ...
	 */
	public static Site remove(long id)
		throws com.df.lonis.ventesservice.exception.NoSuchSiteException {
	 ...
	 * @throws NoSuchSiteException if a site with the primary key could not be found
	 */
	public static Site findByPrimaryKey(long id)
		throws com.df.lonis.ventesservice.exception.NoSuchSiteException {
	 ...
	 */
	public static Site fetchByPrimaryKey(long id) {
	...
	public static void setPersistence(SitePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile SitePersistence _persistence;
