...
/**
 * Provides the local service interface for SiteCommercial. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SiteCommercialLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SiteCommercialLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.SiteCommercialLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the site commercial local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SiteCommercialLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SiteCommercial addSiteCommercial(SiteCommercial siteCommercial);
	...
	public SiteCommercial createSiteCommercial(long id);
	...
	public SiteCommercial deleteSiteCommercial(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SiteCommercial deleteSiteCommercial(SiteCommercial siteCommercial);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SiteCommercial fetchSiteCommercial(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SiteCommercial getSiteCommercial(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SiteCommercial> getSiteCommercials(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SiteCommercial updateSiteCommercial(SiteCommercial siteCommercial);
