...
/**
 * Provides the local service utility for Commission. This utility wraps
 * <code>com.df.lonis.ventesservice.service.impl.CommissionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CommissionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.CommissionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Commission addCommission(Commission commission) {
		return getService().addCommission(commission);
	}
	 ...
	 */
	public static Commission createCommission(long id) {
		return getService().createCommission(id);
	}
	 ...
	 */
	public static Commission deleteCommission(Commission commission) {
		return getService().deleteCommission(commission);
	}
	 ...
	 */
	public static Commission deleteCommission(long id) throws PortalException {
		return getService().deleteCommission(id);
	}
	...
	public static Commission fetchCommission(long id) {
		return getService().fetchCommission(id);
	}
	 ...
	 * @throws PortalException if a commission with the primary key could not be found
	 */
	public static Commission getCommission(long id) throws PortalException {
		return getService().getCommission(id);
	}
	 ...
	 */
	public static List<Commission> getCommissions(int start, int end) {
		return getService().getCommissions(start, end);
	}
	 ...
	 */
	public static int getCommissionsCount() {
		return getService().getCommissionsCount();
	}
	 ...
	 */
	public static Commission updateCommission(Commission commission) {
		return getService().updateCommission(commission);
	}

	public static CommissionLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CommissionLocalService> _serviceSnapshot =
		new Snapshot<>(
			CommissionLocalServiceUtil.class, CommissionLocalService.class);
