 ...
 * <code>com.df.lonis.ventesservice.service.impl.ProduitLocalServiceImpl</code> and
...
public class ProduitLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.ProduitLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Produit createProduit(long id) {
		return getService().createProduit(id);
	}
	 ...
	 */
	public static Produit deleteProduit(long id) throws PortalException {
		return getService().deleteProduit(id);
	}
	 ...
	 * @return the produit that was removed
	 */
	public static Produit deleteProduit(Produit produit) {
	...
	public static Produit fetchProduit(long id) {
		return getService().fetchProduit(id);
	}
	 ...
	 * @throws PortalException if a produit with the primary key could not be found
	 */
	public static Produit getProduit(long id) throws PortalException {
		return getService().getProduit(id);
	}
	 ...
	 */
	public static List<Produit> getProduits(int start, int end) {
	...
	private static final Snapshot<ProduitLocalService> _serviceSnapshot =
		new Snapshot<>(
			ProduitLocalServiceUtil.class, ProduitLocalService.class);
