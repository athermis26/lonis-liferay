...
/**
 * Provides the local service interface for ChiffreAffaires. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChiffreAffairesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ChiffreAffairesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.ChiffreAffairesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the chiffre affaires local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ChiffreAffairesLocalServiceUtil} if injection and service tracking are not available.
	 */
