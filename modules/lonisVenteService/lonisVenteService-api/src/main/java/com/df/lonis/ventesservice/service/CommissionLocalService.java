...
/**
 * Provides the local service interface for Commission. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CommissionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommissionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.CommissionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the commission local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CommissionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Commission createCommission(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Commission deleteCommission(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Commission fetchCommission(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Commission getCommission(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Commission> getCommissions(int start, int end);
