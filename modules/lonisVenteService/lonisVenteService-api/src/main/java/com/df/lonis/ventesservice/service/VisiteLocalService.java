...
/**
 * Provides the local service interface for Visite. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VisiteLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface VisiteLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.df.lonis.ventesservice.service.impl.VisiteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the visite local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link VisiteLocalServiceUtil} if injection and service tracking are not available.
	 */
