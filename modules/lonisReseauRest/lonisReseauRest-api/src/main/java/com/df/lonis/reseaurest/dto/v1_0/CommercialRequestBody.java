 ...
 */
@Generated("")
@GraphQLName("CommercialRequestBody")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CommercialRequestBody")
public class CommercialRequestBody implements Serializable {

	public static CommercialRequestBody toDTO(String json) {
		return ObjectMapperUtil.readValue(CommercialRequestBody.class, json);
	}

	public static CommercialRequestBody unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			CommercialRequestBody.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CommercialRequestBody)) {
			return false;
		}

		CommercialRequestBody commercialRequestBody =
			(CommercialRequestBody)object;

		return Objects.equals(toString(), commercialRequestBody.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.reseaurest.dto.v1_0.CommercialRequestBody",
		name = "x-class-name"
	)
