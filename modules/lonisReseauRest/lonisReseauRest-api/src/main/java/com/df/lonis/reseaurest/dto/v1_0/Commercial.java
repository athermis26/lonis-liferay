...
public class Commercial implements Serializable {
	...
	public static Commercial toDTO(String json) {
		return ObjectMapperUtil.readValue(Commercial.class, json);
	}

	public static Commercial unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Commercial.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.reseaurest.dto.v1_0.Commercial",
		name = "x-class-name"
	)
