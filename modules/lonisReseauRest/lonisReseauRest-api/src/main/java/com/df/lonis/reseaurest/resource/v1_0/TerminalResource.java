...
public interface TerminalResource {
	...
	public Response postTerminalBatch(
			TerminalRequestBody terminalRequestBody, String callbackURL,
			Object object)
		throws Exception;

	public Terminal getTerminal(Long terminalId) throws Exception;

	public Terminal putTerminal(Long terminalId, Terminal terminal)
		throws Exception;

	public Response putTerminalBatch(String callbackURL, Object object)
		throws Exception;
	...
	public Terminal patchTerminalRejeter(Long terminalId, Object object)
		throws Exception;
