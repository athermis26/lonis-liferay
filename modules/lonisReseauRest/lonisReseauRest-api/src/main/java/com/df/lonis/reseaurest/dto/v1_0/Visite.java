...
@XmlRootElement(name = "Visite")
public class Visite implements Serializable {

	public static Visite toDTO(String json) {
		return ObjectMapperUtil.readValue(Visite.class, json);
	}

	public static Visite unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Visite.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), visite.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.reseaurest.dto.v1_0.Visite",
		name = "x-class-name"
	)
