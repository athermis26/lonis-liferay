 ...
 */
@Generated("")
@GraphQLName("SiteCommercial")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SiteCommercial")
public class SiteCommercial implements Serializable {

	public static SiteCommercial toDTO(String json) {
		return ObjectMapperUtil.readValue(SiteCommercial.class, json);
	}

	public static SiteCommercial unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SiteCommercial.class, json);
	}
	...
	public String toString() {
		...
		if (dateDebut != null) {
			...
			sb.append(liferayToJSONDateFormat.format(dateDebut));
		...
		if (dateFin != null) {
			...
			sb.append(liferayToJSONDateFormat.format(dateFin));
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.reseaurest.dto.v1_0.SiteCommercial",
		name = "x-class-name"
	)
