 ...
 */
@Generated("")
@GraphQLName("TerminalRequestBody")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TerminalRequestBody")
public class TerminalRequestBody implements Serializable {

	public static TerminalRequestBody toDTO(String json) {
		return ObjectMapperUtil.readValue(TerminalRequestBody.class, json);
	}

	public static TerminalRequestBody unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			TerminalRequestBody.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.reseaurest.dto.v1_0.TerminalRequestBody",
		name = "x-class-name"
	)
