 ...
 */
@Generated("")
public class Visite implements Cloneable, Serializable {

	public static Visite toDTO(String json) {
		return VisiteSerDes.toDTO(json);
	}
	...
	@Override
	public Visite clone() throws CloneNotSupportedException {
		return (Visite)super.clone();
	}
	...
	public String toString() {
		return VisiteSerDes.toJSON(this);
	}
