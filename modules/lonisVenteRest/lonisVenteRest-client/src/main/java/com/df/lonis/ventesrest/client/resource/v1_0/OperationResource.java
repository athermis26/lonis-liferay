...
public interface OperationResource {
	...
	public HttpInvoker.HttpResponse getOperationHttpResponse(Long operationId)
		throws Exception;
	...
	public static class Builder {
		...
		public OperationResource build() {
			return new OperationResourceImpl(this);
		}
	...
	public static class OperationResourceImpl implements OperationResource {
		...
		public Page<Operation> getOperationsPage(
			...
			try {
				return Page.of(content, OperationSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public OperationDetail getOperation(Long operationId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getOperationHttpResponse(
				operationId);
			...
			try {
				return OperationDetailSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getOperationHttpResponse(
				Long operationId)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/lonisVenteRest/v1.0/operations/{operationId}");

			httpInvoker.path("operationId", operationId);
		...
		private OperationResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OperationResource.class.getName());
