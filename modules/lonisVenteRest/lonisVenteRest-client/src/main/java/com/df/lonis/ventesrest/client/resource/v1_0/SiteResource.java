...
public interface SiteResource {
	...
	public HttpInvoker.HttpResponse getAllSitesHttpResponse() throws Exception;
	...
	public static class SiteResourceImpl implements SiteResource {
		...
		public HttpInvoker.HttpResponse getSitesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/lonisVenteRest/v1.0/sites");
		...
		public Page<Site> getAllSites() throws Exception {
			HttpInvoker.HttpResponse httpResponse = getAllSitesHttpResponse();
		...
		public HttpInvoker.HttpResponse getAllSitesHttpResponse()
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/lonisVenteRest/v1.0/sites-all");
