...
public abstract class BaseConcessionnaireResourceImpl
	implements ConcessionnaireResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<Concessionnaire> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/lonisVenteRest/v1.0/concessionnaires'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Liste paginée des concessionnaires"
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/concessionnaires")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/lonisVenteRest/v1.0/concessionnaires/top-actifs'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Top concessionnaires les plus actifs par chiffre d'affaires"
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/concessionnaires/top-actifs")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@Override
	public Page<Concessionnaire> read(
			Filter filter, Pagination pagination, Sort[] sorts,
			Map<String, Serializable> parameters, String search)
		throws Exception {

		return getConcessionnairesPage(search, filter, pagination, sorts);
	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseConcessionnaireResourceImpl.class);
