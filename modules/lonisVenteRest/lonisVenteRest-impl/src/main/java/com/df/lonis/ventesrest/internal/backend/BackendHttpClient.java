...
/**
 * Client HTTP OSGi vers le backend Spring Boot.
 *
 * Configuration : voir {@link BackendClientConfiguration}.
 * Authentification : envoie automatiquement l'en-tête {@code X-API-Key}.
 */
@Component(
		configurationPid = "com.df.lonis.ventesrest.internal.backend.BackendClientConfiguration",
		immediate = true,
...
public class BackendHttpClient {
	...
	protected void activate(Map<String, Object> properties) {
		...
		if (_log.isInfoEnabled()) {
			_log.info("BackendHttpClient activé sur " + _configuration.baseUrl());
		}
	}
