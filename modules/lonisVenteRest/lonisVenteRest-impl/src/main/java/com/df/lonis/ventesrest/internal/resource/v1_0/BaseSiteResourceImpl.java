...
public abstract class BaseSiteResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/lonisVenteRest/v1.0/sites'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/lonisVenteRest/v1.0/sites-all'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Liste des sites sans pagination"
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Site")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/sites-all")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	public Page<Site> read(
		...
		return getSitesPage(search, filter, pagination, sorts);
	}
