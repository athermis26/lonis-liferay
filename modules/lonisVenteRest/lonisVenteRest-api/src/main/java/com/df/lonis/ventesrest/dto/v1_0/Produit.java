...
public class Produit implements Serializable {
	...
	public static Produit toDTO(String json) {
		return ObjectMapperUtil.readValue(Produit.class, json);
	}

	public static Produit unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Produit.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.ventesrest.dto.v1_0.Produit",
		name = "x-class-name"
	)
