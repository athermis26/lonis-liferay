 ...
 */
@Generated("")
@GraphQLName("TerminauxConcessionnaire")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TerminauxConcessionnaire")
public class TerminauxConcessionnaire implements Serializable {

	public static TerminauxConcessionnaire toDTO(String json) {
		return ObjectMapperUtil.readValue(TerminauxConcessionnaire.class, json);
	}

	public static TerminauxConcessionnaire unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			TerminauxConcessionnaire.class, json);
	}
	...
	public String toString() {
		...
		if (terminalDetails != null) {
			...
			for (int i = 0; i < terminalDetails.length; i++) {
				sb.append(String.valueOf(terminalDetails[i]));

				if ((i + 1) < terminalDetails.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.ventesrest.dto.v1_0.TerminauxConcessionnaire",
		name = "x-class-name"
	)
