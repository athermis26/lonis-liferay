 ...
 */
@Generated("")
@GraphQLName("OperationDetail")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "OperationDetail")
public class OperationDetail implements Serializable {

	public static OperationDetail toDTO(String json) {
		return ObjectMapperUtil.readValue(OperationDetail.class, json);
	}

	public static OperationDetail unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(OperationDetail.class, json);
	}
	...
	public String toString() {
		...
		if (codeOperation != null) {
			...
			sb.append(_escape(codeOperation));
		...
		if (dateHeure != null) {
			...
			sb.append(liferayToJSONDateFormat.format(dateHeure));
	...
	@Schema(
		...
		defaultValue = "com.df.lonis.ventesrest.dto.v1_0.OperationDetail",
		name = "x-class-name"
	)
